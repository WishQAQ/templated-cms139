...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a href='".str_replace("{page}",$prepagenum,$tnamerule)."' class='l'></a>\r\n";
            $indexpage="<a href='".str_replace("{page}",1,$tnamerule)."' class='l'></a>\r\n";
        }
        else
        {
            $indexpage="<a href='".str_replace("{page}",1,$tnamerule)."' class='l'></a>\r\n";
        ...
        {
            $nextpage.="<a href='".str_replace("{page}",$nextpagenum,$tnamerule)."' class='r'></a>\r\n";
            $endpage="<a href='".str_replace("{page}",$totalpage,$tnamerule)."' class='r'></a>\r\n";
        }
        else
        {
            $endpage="<a href='".str_replace("{page}",$totalpage,$tnamerule)."' class='r'></a>\r\n";
